...
class AiAssistantService {
  ...
  static const _localHints = <String, String>{
    'طقس':
        'تذكر عناصر الطقس الأربعة: الشمس، الحرارة، الرياح، والهطول. حاول ربط كل صورة بعنصر منها!',
    'كوكب':
        'رتّب الكواكب من الأقرب للشمس: عطارد، الزهرة، الأرض، المريخ... جرّب أن تحفظها بجملة طريفة!',
    'كسوف':
        'الكسوف يحدث عندما يقف القمر بين الأرض والشمس. حرّك الأجرام الثلاثة وشاهد الظل يتكوّن.',
    'خسوف':
        'الخسوف يحدث عندما تقف الأرض بين الشمس والقمر. جرّب رسم الترتيب الصحيح بنفسك.',
    'سلسلة غذائية': 'كل سلسلة غذائية تبدأ من نبات! فكّر من يأكل من، خطوة خطوة.',
    'تنوع حيوي':
        'لكل كائن حي بيئته المناسبة. حاول تخيل أين يعيش هذا الكائن في فلسطين.',
    'ضوء':
        'الضوء ينعكس بزاوية مساوية لزاوية سقوطه على المرآة — جرّب تدوير المرآة قليلاً!',
  };
